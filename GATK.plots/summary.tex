...
Sampl & 65 & 0.38 & 0.38 & 602 & -- & 0 & 0 \\ 
GATK & 0 & 0.00 & 0.00 & 478 & -- & 0 & 0 \\ 
Sampl + GATK & 935 & 0.53 & 0.53 & 1,398 & -- & 0 & 0 \\ 
%
...
Sampl & 100.0\% & 0.38 & 100.0\% & 0 &0 \\ 
GATK & 0.0\% & 0.00 & 0.0\% & 0 &0 \\ 
Sampl + GATK & 100.0\% & 0.53 & 100.0\% & 0 &0 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item Sampl .. \texttt{\footnotesize Sample.vcf.gz}
\item GATK .. \texttt{\footnotesize GATK.vcf.gz}
...
% Indel distribution
%
\hslide{Indel distribution}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=8cm]{indels.0}\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=8cm]{indels.1}\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=8cm]{indels.2}}
