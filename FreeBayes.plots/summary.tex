...
Sampl & 19 & 0.12 & 0.12 & 2,000 & -- & 0 & 0 \\ 
FreeB & 275 & 0.99 & 0.99 & 2,008 & -- & 0 & 1 \\ 
Sampl + FreeB & 981 & 0.53 & 0.53 & 0 & -- & 0 & 0 \\ 
%
...
Sampl & 100.0\% & 0.12 & 100.0\% & 0 &0 \\ 
FreeB & 0.0\% & 0.00 & 2.0\% & 1 &0 \\ 
Sampl + FreeB & 100.0\% & 0.53 & 0.0\% & 0 &0 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item Sampl .. \texttt{\footnotesize Sample.vcf.gz}
\item FreeB .. \texttt{\footnotesize FreeBayes.vcf.gz}
...
%
\hslide{Ts/Tv stratified by QUAL}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{tstv_by_qual.1}}

% Indel distribution
%
\hslide{Indel distribution}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=10cm]{indels.0}\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=10cm]{indels.1}}

% Depth distribution
%
\hslide{Depth distribution}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{depth.1}}

% Substitution types
%
\hslide{Substitution types}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=8cm]{substitutions.0}\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=8cm]{substitutions.1}\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=8cm]{substitutions.2}}
