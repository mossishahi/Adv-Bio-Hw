...
#   plot-vcfstats FreeBayes.stats -p FreeBayes.plots
#
...
# 	 1 .. FreeB .. FreeBayes.vcf.gz
# 	 2 .. Sampl + FreeB .. Sample.vcf.gz
#
...
if plot_venn_snps:
	...
	ax1.bar([1,2,3],[19,981,275],align='center',color='orange',width=0.3)
...
if plot_venn_indels:
	fig = plt.figure(figsize=(4.33070866141732,3.93700787401575))
	ax1 = fig.add_subplot(111)
	ax1.bar([1,2,3],[2000,0,2008],align='center',color='red',width=0.3)
	ax1.ticklabel_format(style='sci', scilimits=(0,0), axis='y')
	ax1.set_xlim(0.5,3.5)
	plt.xticks([1,2,3],('Sampl\n2,000','Sampl + FreeB\n0','FreeB\n2,008'))
...
if plot_SNP_count_by_af:
	...
	if 2 in dat and len(dat[2])>2:
		ax1.plot([row[0] for row in dat[2]], [row[1] for row in dat[2]], '-o',markersize=3, color='darkgreen',mec='darkgreen',label='Sampl + FreeB')
		has_data = 1
